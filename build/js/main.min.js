...
/* harmony import */ var _modules_init_grain__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-grain */ "./js/modules/init-grain.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_grain__WEBPACK_IMPORTED_MODULE_4__["initGrain"])();
  });
}); // ---------------------------------
  ...
  _createClass(Grain, [{
    ...
    value: function update() {
      var patternPixelDataLength = this.patternPixelDataLength,
          ...
          patternCtx = this.patternCtx; // put a random shade of gray into every pixel of the pattern
...
/***/ "./js/modules/init-grain.js":
/*!**********************************!*\
  !*** ./js/modules/init-grain.js ***!
  \**********************************/
/*! exports provided: initGrain */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initGrain", function() { return initGrain; });
/* harmony import */ var _grain__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./grain */ "./js/modules/grain.js");

var grainElements = document.querySelectorAll('[data-grain]');
var initGrain = function initGrain() {
  grainElements.forEach(function (element) {
    return new _grain__WEBPACK_IMPORTED_MODULE_0__["default"](element);
  });
};
